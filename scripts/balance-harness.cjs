...
(async () => {
  ...
  // Costs mirror constants.ts, but PER UNIT SPAWNED: the buys that put several
  // bodies on the field must be divided, or their efficiency is understated by
